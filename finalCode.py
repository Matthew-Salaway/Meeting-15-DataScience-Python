...
for i in range(len(dataset)):
    ...
    if row[3] == "b":
        boys = boys + 1
        totalBoyShoes = totalBoyShoes + row[1]
    else:
        girls = girls + 1
        totalGirlShoes = totalGirlShoes + row[1]

print(totalBoyShoes)
print(boys)
print(totalGirlShoes)
print(girls)

shoesPerBoy = totalBoyShoes/boys
print(shoesPerBoy)
shoesPerGirl = totalGirlShoes/girls
print(shoesPerGirl)
